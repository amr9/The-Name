...
//
// BRAND_MARK is the one entry that is not a shape: it stands for The Name's
// outline N mark (media.brand.markOutline), which the component draws as an
// image on a lighter skin. Each set carries it once, among the other shapes.
